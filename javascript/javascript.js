...
window.onload = function(){
    ...
    if(randSelector === 1){
        ...
        setInterval(placeCoin, 5500); // Coin will spawn every 5.5s
        setInterval(placeBomb, 3000); // Bomb will spawn every 3s
    }
    else if(randSelector === 3){
        setInterval(placeCoin, 5500); // Coin will spawn every 5.5s
        setInterval(placeBomb, 3000); // Bomb will spawn every 3s
...
function update(){
    ...
    if(gameWin){
        gameWinContainer.style.display = "block";
        gameContainer.style.display = "none";
        return;
    }
